...
const MyEnrollments = () => {
    ...
    // const percent = progressArray[index] ? (progressArray[index].lectureCompleted * 100) / progressArray[index].totalLectures : 0;
                ...
                <table className="md:table-auto table-fixed w-full overflow-hidden border mt-10">
                    ...
                    <tbody className="text-gray-700">
                        {enrolledCourses.map((course, index) => {
                            const percent = progressArray[index]
                            ...
                            return (
                                <tr key={index} className="border-b border-gray-500/20">
                                    <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3">
                                        <img src={course.courseThumbnail} alt="courseThumbnail" className="w-14 sm:w-24 md:w-28" />
